...
namespace vbSparkle
{
    public class VbSimpleBlock : VbGenericBlock<VBScriptParser.BlockStmtContext>
    {
        public VbSimpleBlock(
           IVBScopeObject context,
           VBScriptParser.BlockStmtContext @object)
            : base(context, @object)
        {
            Append(@object);
        }
        ...
        public void Append(VBScriptParser.BlockStmtContext @object)
        {
            ...
            if (Append(@object.goToStmt()))
                return;
            if (Append(@object.ifThenElseStmt()))
                return;
